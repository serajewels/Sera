          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-3 md:gap-0">
            ...
            <div className="flex justify-between items-center w-full">
              ...
              <div className="flex items-center space-x-4 md:space-x-6 text-xl z-10 relative">
                ...
                {userInfo && userInfo.role === 'admin' && (
                  <Link to="/admin" className="hidden md:block text-sm font-bold uppercase tracking-wider border border-current px-2 py-1 rounded hover:opacity-75 transition-opacity">
                    Admin
                  </Link>
                )}
            ...
            {userInfo && userInfo.role === 'admin' && (
              <div className="flex md:hidden justify-center w-full -mt-2">
                <Link to="/admin" className="text-xs font-bold uppercase tracking-wider border border-current px-3 py-1.5 rounded hover:opacity-75 transition-opacity">
                  Admin Panel
                </Link>
              </div>
            )}
